...
- [x] Theme toggle switches between dark and light modes instantly
- [x] System theme preference is detected and applied on first visit
- [x] Default content type setting pre-selects type in content creation form
- [x] Dashboard widgets can be reordered and hidden/shown
- [x] Notification preferences control email and in-app notification frequency
- [x] Keyboard shortcuts help modal shows all available shortcuts
- [x] Settings are automatically saved and persist across browser sessions
- [x] Settings page is accessible and follows WCAG guidelines
