...
- [x] Users can export all content data in JSON, CSV, and OPML formats
- [x] Import successfully processes Pocket and Instapaper export files
...
- [x] Import validation detects and reports data format errors clearly
- [x] Import preview shows what will be imported before processing
- [x] Duplicate detection prevents importing existing content
- [x] Export filtering works correctly for date ranges and tag/category selection
